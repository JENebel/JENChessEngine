...
pub fn generate_moves(game: &mut Game) -> MoveList {
    ...
    if game.active_player == Color::White {
        ...
        while !pawn_bitboard.is_empty() {
            ...
            if !game.all_occupancies.get_bit(to_sq) {
                ...
                if to_sq >= 8 {
                    //Quiet move
                    add_move_if_legal(game, &mut moves, Move::new(from_sq, to_sq, Piece::WhitePawn as u8, Piece::None as u8, false, false, false, false));

                    //Double push
                    to_sq = (to_sq as i8 - 8) as u8;
                    if !game.all_occupancies.get_bit(to_sq) && from_sq / 8 == 6 {
                        add_move_if_legal(game, &mut moves, Move::new(from_sq, to_sq, Piece::WhitePawn as u8, Piece::None as u8, false, true, false, false));
                    }
                }
                //Promotions
                else {
                    add_move_if_legal(game, &mut moves, Move::new(from_sq, to_sq, Piece::WhitePawn as u8, Piece::WhiteQueen as u8,  false, false, false, false));
                    add_move_if_legal(game, &mut moves, Move::new(from_sq, to_sq, Piece::WhitePawn as u8, Piece::WhiteKnight as u8, false, false, false, false));
                    add_move_if_legal(game, &mut moves, Move::new(from_sq, to_sq, Piece::WhitePawn as u8, Piece::WhiteRook as u8,   false, false, false, false));
                    add_move_if_legal(game, &mut moves, Move::new(from_sq, to_sq, Piece::WhitePawn as u8, Piece::WhiteBishop as u8, false, false, false, false))
                }
            }
            ...
            if game.enpassant_square != Square::None && !attacks.and(Bitboard::from_u64(1 << game.enpassant_square as u8)).is_empty(){
                add_move_if_legal(game, &mut moves, Move::new(from_sq, game.enpassant_square as u8, Piece::WhitePawn as u8, Piece::None as u8, true, false, true, false));
            }
            ...
            while !attacks.is_empty() {
                ...
                //Regular captures
                if to_sq >= 8 {
                    add_move_if_legal(game, &mut moves, Move::new(from_sq, to_sq, Piece::WhitePawn as u8, Piece::None as u8, true, false, false, false));

                //Promotions
                } else {
                    add_move_if_legal(game, &mut moves, Move::new(from_sq, to_sq, Piece::WhitePawn as u8, Piece::WhiteQueen as u8,  true, false, false, false));
                    add_move_if_legal(game, &mut moves, Move::new(from_sq, to_sq, Piece::WhitePawn as u8, Piece::WhiteKnight as u8, true, false, false, false));
                    add_move_if_legal(game, &mut moves, Move::new(from_sq, to_sq, Piece::WhitePawn as u8, Piece::WhiteRook as u8,   true, false, false, false));
                    add_move_if_legal(game, &mut moves, Move::new(from_sq, to_sq, Piece::WhitePawn as u8, Piece::WhiteBishop as u8, true, false, false, false))
                }
            }
        }
        ...
        if  game.castling_ability & (CastlingAbility::WhiteKingSide as u8) != 0 &&              //castling ability
            ...
            !game.is_square_attacked(Square::f1 as u8, Color::Black) {                          //f1 is not under attack
                ...
                add_move_if_legal(game, &mut moves, Move::new(Square::e1 as u8, Square::g1 as u8, Piece::WhiteKing as u8, Piece::None as u8, false, false, false, true))
        }
        //Castling queen
        if  game.castling_ability & (CastlingAbility::WhiteQueenSide as u8) != 0 &&             //castling ability
            ...
            !game.is_square_attacked(Square::d1 as u8, Color::Black) {                          //d1 is not under attack
                ...
                add_move_if_legal(game, &mut moves, Move::new(Square::e1 as u8, Square::c1 as u8, Piece::WhiteKing as u8, Piece::None as u8, false, false, false, true))
        }
    }
    //BLACK
    else {
        ...
        while !pawn_bitboard.is_empty() {
            ...
            if !game.all_occupancies.get_bit(to_sq) {
                ...
                if to_sq <= 55 {
                    //Quiet move
                    add_move_if_legal(game, &mut moves, Move::new(from_sq, to_sq, Piece::BlackPawn as u8, Piece::None as u8, false, false, false, false));

                    //Double push
                    to_sq = (to_sq as i8 + 8) as u8;
                    if !game.all_occupancies.get_bit(to_sq) && from_sq / 8 == 1 {
                        add_move_if_legal(game, &mut moves, Move::new(from_sq, to_sq, Piece::BlackPawn as u8, Piece::None as u8, false, true, false, false));
                    }
                }
                //Promotions
                else {
                    add_move_if_legal(game, &mut moves, Move::new(from_sq, to_sq, Piece::BlackPawn as u8, Piece::BlackQueen as u8,  false, false, false, false));
                    add_move_if_legal(game, &mut moves, Move::new(from_sq, to_sq, Piece::BlackPawn as u8, Piece::BlackKnight as u8, false, false, false, false));
                    add_move_if_legal(game, &mut moves, Move::new(from_sq, to_sq, Piece::BlackPawn as u8, Piece::BlackRook as u8,   false, false, false, false));
                    add_move_if_legal(game, &mut moves, Move::new(from_sq, to_sq, Piece::BlackPawn as u8, Piece::BlackBishop as u8, false, false, false, false))
                }
            }
            ...
            //enpassant
            if game.enpassant_square != Square::None && !attacks.and(Bitboard::from_u64(1 << game.enpassant_square as u8)).is_empty(){
                add_move_if_legal(game, &mut moves, Move::new(from_sq, game.enpassant_square  as u8, Piece::BlackPawn as u8, Piece::None as u8, true, false, true, false));
            }
            ...
            while !attacks.is_empty() {
                ...
                //Regular captures
                if to_sq <= 55 {
                    add_move_if_legal(game, &mut moves, Move::new(from_sq, to_sq, Piece::BlackPawn as u8, Piece::None as u8, true, false, false, false));

                //Promotions
                } else {
                    add_move_if_legal(game, &mut moves, Move::new(from_sq, to_sq, Piece::BlackPawn as u8, Piece::BlackQueen as u8,  true, false, false, false));
                    add_move_if_legal(game, &mut moves, Move::new(from_sq, to_sq, Piece::BlackPawn as u8, Piece::BlackKnight as u8, true, false, false, false));
                    add_move_if_legal(game, &mut moves, Move::new(from_sq, to_sq, Piece::BlackPawn as u8, Piece::BlackRook as u8,   true, false, false, false));
                    add_move_if_legal(game, &mut moves, Move::new(from_sq, to_sq, Piece::BlackPawn as u8, Piece::BlackBishop as u8, true, false, false, false))
                }
            }
        }

        //Castling kingside
        if  game.castling_ability & (CastlingAbility::BlackKingSide as u8) != 0 &&              //castling ability
            ...
            !game.is_square_attacked(Square::f8 as u8, Color::White) {                          //f8 is not under attack
                ...
                add_move_if_legal(game, &mut moves, Move::new(Square::e8 as u8, Square::g8 as u8, Piece::BlackKing as u8, Piece::None as u8, false, false, false, true))
        }
        //Castling queen
        if  game.castling_ability & (CastlingAbility::BlackQueenSide as u8) != 0 &&             //castling ability
            ...
            !game.is_square_attacked(Square::d8 as u8, Color::White) {                          //d8 is not under attack
                ...
                add_move_if_legal(game, &mut moves, Move::new(Square::e8 as u8, Square::c8 as u8, Piece::BlackKing as u8, Piece::None as u8, false, false, false, true))
        }
    }
    ...
    while !knight_bitboard.is_empty() {
        ...
        while !quiet.is_empty() {
            ...
            add_move_if_legal(game, &mut moves, Move::new(from_sq, to_sq, knight, Piece::None as u8, false, false, false, false))
        }
        ...
        while !attacks.is_empty() {
            to_sq = attacks.extract_bit();
            add_move_if_legal(game, &mut moves, Move::new(from_sq, to_sq, knight, Piece::None as u8, true, false, false, false))
        }
    }
    ...
    while !bishop_bitboard.is_empty() {
        ...
        while !quiet.is_empty() {
            to_sq = quiet.extract_bit();
            add_move_if_legal(game, &mut moves, Move::new(from_sq, to_sq, bishop, Piece::None as u8, false, false, false, false))
        }
        ...
        while !attacks.is_empty() {
            to_sq = attacks.extract_bit();
            add_move_if_legal(game, &mut moves, Move::new(from_sq, to_sq, bishop, Piece::None as u8, true, false, false, false))
        }
    }
    ...
    while !rook_bitboard.is_empty() {
        ...
        while !quiet.is_empty() {
            to_sq = quiet.extract_bit();
            add_move_if_legal(game, &mut moves, Move::new(from_sq, to_sq, rook, Piece::None as u8, false, false, false, false))
        }
        ...
        while !attacks.is_empty() {
            to_sq = attacks.extract_bit();
            add_move_if_legal(game, &mut moves, Move::new(from_sq, to_sq, rook, Piece::None as u8, true, false, false, false))
        }
    }
    ...
    while !queen_bitboard.is_empty() {
        ...
        while !quiet.is_empty() {
            to_sq = quiet.extract_bit();
            add_move_if_legal(game, &mut moves, Move::new(from_sq, to_sq, queen, Piece::None as u8, false, false, false, false))
        }
        ...
        while !attacks.is_empty() {
            to_sq = attacks.extract_bit();
            add_move_if_legal(game, &mut moves, Move::new(from_sq, to_sq, queen, Piece::None as u8, true, false, false, false))
        }
    }
    ...
    while !king_bitboard.is_empty() {
        ...
        while !quiet.is_empty() {
            to_sq = quiet.extract_bit();
            add_move_if_legal(game, &mut moves, Move::new(from_sq, to_sq, king, Piece::None as u8, false, false, false, false))
        }
        ...
        while !attacks.is_empty() {
            to_sq = attacks.extract_bit();
            add_move_if_legal(game, &mut moves, Move::new(from_sq, to_sq, king, Piece::None as u8, true, false, false, false))
        }
    }
...
mod move_gen_tests {
    ...
    pub fn can_not_move_pawn_when_piece_in_the_way() {
        ...
        let moves = generate_moves(&mut game).all_from(Square::b2);
    ...
    pub fn white_pawn_should_have_4_promotion_options_when_reaching_back_row() {
        ...
        let moves = generate_moves(&mut game).all_from(Square::c7);
    ...
    pub fn white_knight_has_2_right_legal_moves_at_start() {
        let mut game = Game::new_from_start_pos();
        let moves = generate_moves(&mut game).all_from(Square::b1);
        assert!(moves.len() == 2);
    ...
    pub fn king_can_move_in_all_directions() {
        ...
        let moves = generate_moves(&mut game).all_from(Square::b7);
        assert!(moves.len() == 8);
    ...
    pub fn king_cannot_move_over_edge() {
        ...
        let moves = generate_moves(&mut game).all_from(Square::a7);
        assert!(moves.len() == 5);
    ...
    pub fn rook_has_no_legal_moves_at_start() {
        let mut game = Game::new_from_start_pos();
        let moves = generate_moves(&mut game).all_from(Square::a1);
        assert!(moves.len() == 0);
    }
    ...
    pub fn  queen_has_no_legal_moves_at_start() {
        let mut game = Game::new_from_start_pos();
        let moves = generate_moves(&mut game).all_from(Square::d1);
        assert!(moves.len() == 0);
    }
    ...
    pub fn queen_has_correct_number_of_legal_moves_on_open_board() {
        ...
        let moves = generate_moves(&mut game).all_from(Square::d4);
        assert!(moves.len() == 27);
    ...
    pub fn queen_has_correct_number_of_moves_when_friendlies_in_the_way() {
        ...
        let moves = generate_moves(&mut game).all_from(Square::b6);
        assert!(moves.len() == 3);
    }
    ...
    pub fn castling_moves_are_found_for_white() {
        ...
        let moves = generate_moves(&mut game).all_from(Square::e1);
    ...
    pub fn castling_moves_are_found_for_black() {
        ...
        let moves = generate_moves(&mut game).all_from(Square::e8);
    ...
    pub fn rooks_should_have_5_moves_here() {
        ...
        assert_eq!(generate_moves(&mut game).all_from(Square::h1).len(), 6);
        assert_eq!(generate_moves(&mut game).all_from(Square::a1).len(), 6);
    }
    ...
    pub fn knight_should_have_a_capture_move() {
        ...
        assert_eq!(generate_moves(&mut game).all_from(Square::a1).contains(&Move::new_friendly(Square::a1, Square::b3, Piece::WhiteKnight, Piece::None, true, false, false, false)), true);
    }
    ...
    pub fn bishop_should_have_a_capture_move() {
        ...
        assert_eq!(generate_moves(&mut game).all_from(Square::f1).contains(&Move::new_friendly(Square::f1, Square::b5, Piece::WhiteBishop, Piece::None, true, false, false, false)), true);
    }
    ...
    pub fn rook_captured_by_pawn_generates_right_move() {
        ...
        let moves = generate_moves(&mut game).all_from(Square::b3);
    ...
    pub fn pawns_cant_capture_straight() {
        ...
        let moves = generate_moves(&mut game).all_from(Square::d8);
    ...
    pub fn pawns_cant_move_straight_into_piece() {
        let mut game = Game::new_from_fen("k7/8/8/p7/P7/8/8/K7 w K - 0 25").unwrap();
        let moves = generate_moves(&mut game).all_from(Square::a4);
    ...
    pub fn rook_should_not_have_illegal_moves() {
        ...
        let moves = generate_moves(&mut game).all_from(Square::a8);
        assert_eq!(moves.len(), 1);
    }
